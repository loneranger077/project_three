...
function AppPage(props) {
  ...
  return (
    <div className="container" id="musicbtn">
      <div>
        <div>
          <button onClick={() => sound1.play()} className="playSound" id="kick">
            Basic Kick Drum
          </button>
        </div>
        <div>
        ...
        <div>
          <button onClick={() => sound4.play()} className="playSound" id="clap">
            Basic Clap Drum
          </button>
        </div>
        <div>
          <button onClick={() => sound2.play()} className="playSound" id="hat">
            Basic Hat Drum
          </button>
        </div>
        <div>
          <button onClick={() => sound5.play()} className="playSound" id="hat">
            Jazz Guitar C Note
          </button>
        </div>
      </div>
